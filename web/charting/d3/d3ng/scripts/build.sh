...
GOS_PROJECT_NAME="Geirmundur Orri Sigurdsson Experiment D3"
...
GOS_CMAKE_CREATE_OPTIONS="${GOS_CMAKE_CREATE_OPTIONS} -DGOS_EM_TARGET:BOOL=On"
...
GOS_CP_LIB_CMD="cp ${GOS_PROJECT_ARTIFACTS_DIR}/lib/*.js ${GOS_ROOT_DIR}/src/assets/wasm/"
echo "${GOS_CP_LIB_CMD}"
${GOS_CP_LIB_CMD}
GOS_CP_LIB_CMD="cp ${GOS_PROJECT_ARTIFACTS_DIR}/lib/*.wasm ${GOS_ROOT_DIR}/src/assets/wasm/"
echo "${GOS_CP_LIB_CMD}"
${GOS_CP_LIB_CMD}
GOS_CP_LIB_CMD="cp ${GOS_PROJECT_ARTIFACTS_DIR}/lib/*.data ${GOS_ROOT_DIR}/src/assets/wasm/"
echo "${GOS_CP_LIB_CMD}"
${GOS_CP_LIB_CMD}
