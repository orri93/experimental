...
(function (factory) {
    if (typeof module === 'object' && module.exports) {
        ...
        factory(Highcharts, Delaunay);
    }
}(function (Highcharts, Delaunay) {
    (function (H) {
        ...
        */
        H.ColorAxis.prototype.toRelativePosition = function (value) {
            if (this.isLog) {
        ...
        wrap(H.ColorAxis.prototype, 'setAxisSize', function (proceed) {
        ...
        seriesTypes.contour = extendClass(seriesTypes.heatmap, {
            ...
            //FIXME: Once https://github.com/H/H/pull/5497 has landed, this whole method can go away
            translate: function () {
                if (!this.is3d) {
        ...
        //Once https://github.com/H/H/pull/5498 has landed, this whole method can go away
        H.ColorAxis.prototype.render = function () {
            ...
            H.Axis.prototype.render.call(this, arguments);
            if (is3d) {
                this.chart.options.chart.options3d.enabled = true;
            }
        };
