 ...
 *
 * Compile
 * emcc -Os soil/libSOIL.bc 3dcube.c -o 3dcube.js -s LEGACY_GL_EMULATION=1 -Isoil -s EXTRA_EXPORTED_RUNTIME_METHODS="['ccall']" -s FORCE_FILESYSTEM=1 -s MODULARIZE=1 -s EXPORT_NAME="Cube3dModule"
 * 
 */
