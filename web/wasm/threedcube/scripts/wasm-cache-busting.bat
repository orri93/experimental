...
SET GOS_PROJECT_SCRIPTS_DIR=%GOS_PROJECT_ROOT_DIR%\scripts

SET GOS_SCRIPT_CMD="%EMSDK_NODE%" "%GOS_PROJECT_SCRIPTS_DIR%\wasm-cache-busting.js"

ECHO Execute node script command
ECHO %GOS_SCRIPT_CMD%
%GOS_SCRIPT_CMD%
