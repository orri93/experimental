...
SET GOS_EMCC_OPTIONS=-Os "%GOS_PROJECT_WASM_SRC_DIR%\3d-cube\soil\libSOIL.bc" "%GOS_PROJECT_WASM_SRC_DIR%\3d-cube\3d-cube.c" -o "%GOS_PROJECT_WASM_ASSET_DIR%\3d-cube.js" -s LEGACY_GL_EMULATION=1 -Isrc/app/wasm/3d-cube/soil -s EXTRA_EXPORTED_RUNTIME_METHODS="['ccall']" -s FORCE_FILESYSTEM=1 -s MODULARIZE=1 -s EXPORT_NAME="Cube3dModule"
