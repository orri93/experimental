...
@Component({
  selector: 'app-three-dee-cube',
  templateUrl: './three-dee-cube.component.html',
  styleUrls: ['./three-dee-cube.component.css']
})
export class ThreeDeeCubeComponent extends EmscriptenWasmComponent {
  ...
  selectPredefinedImage(index: number) {
    ...
    this.httpClient
      ...
      .subscribe((imageBytes) => this.setTexture(
