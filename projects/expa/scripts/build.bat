...
SET GOS_TIER_B=%GOS_ROOT_DIR%\bin\tierb.exe
...
REM SET GOS_CMAKE_SYSTEM=Visual Studio 16 2019
SET GOS_CMAKE_SYSTEM=MinGW Makefiles
...
-DGOS_USE_CLOCK_GETTIME:BOOL=On ^
-DGOS_EXPA_EMSCRIPTEN_BUILD:BOOL=On ^
-G "%GOS_CMAKE_SYSTEM%" ^
"%GOS_ROOT_DIR%"
...
REM SET GOS_CP_LIB_CMD=xcopy "%GOS_PROJECT_ARTIFACTS_DIR%\lib\*.lib" "%GOS_ROOT_DIR%\lib\" /Y
...
ECHO *** Build Go Tier
SET GOS_GO_BUILD_CMD=go build -o "%GOS_TIER_B%" "%GOS_ROOT_DIR%\src\tierb\tier.go"
