...
SET GOS_PROJECT_NAME=Compile Web Assembly GOS Experimental Library
...
SET GOS_PROJECT_C_DIR=%GOS_PROJECT_ROOT_DIR%\c
SET GOS_PROJECT_C_GOS_DIR=%GOS_PROJECT_C_DIR%\gos
SET GOS_PROJECT_INCLUDE_DIR=%GOS_PROJECT_ROOT_DIR%\include
SET GOS_PROJECT_WASM_DIR=%GOS_PROJECT_ROOT_DIR%\wasm

ECHO Enter %GOS_PROJECT_ROOT_DIR%
PUSHD "%GOS_PROJECT_ROOT_DIR%"
ECHO Execute emcc compiler commands

SET GOS_EMCC_OPTIONS=-Iinclude "%GOS_PROJECT_C_GOS_DIR%\color.c" "%GOS_PROJECT_C_GOS_DIR%\interpolate.c" "%GOS_PROJECT_C_GOS_DIR%\noise.c" -o "%GOS_PROJECT_WASM_DIR%\libGOS.bc"
